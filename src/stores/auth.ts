...
export const ROLE_NAV_ITEMS: Record<StaffType, string[]> = {
  headteacher: ['dashboard', 'students', 'staff', 'academics', 'meetings', 'attendance', 'marks', 'wallet', 'tasks', 'transport', 'finance', 'communication', 'conferences', 'calendar', 'reports', 'audit-logs', 'terminal', 'settings', 'library', 'hostel', 'inventory', 'behavior', 'alumni', 'assignments', 'course-sites', 'exams', 'lesson-plans', 'feedback', 'ai-tutor'],
  admin: ['dashboard', 'students', 'staff', 'academics', 'meetings', 'attendance', 'marks', 'wallet', 'tasks', 'transport', 'finance', 'communication', 'conferences', 'calendar', 'reports', 'audit-logs', 'terminal', 'settings', 'library', 'hostel', 'inventory', 'behavior', 'alumni', 'assignments', 'course-sites', 'exams', 'lesson-plans', 'feedback', 'ai-tutor'],
